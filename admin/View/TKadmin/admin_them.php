              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <h4 class="card-title">THÊM NGƯỜI DÙNG</h4>
                   <form action="admin_xlthem.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Small" name="admin_name" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      ...
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Small" name="password" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">Quyền Ngưòi Dùng</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Small" name="permission_id" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      <input type="submit" name="Them" value="Tạo Người Dùng">
                    </form> 
