              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH QUẢN LÝ ADMIN</h1>
                        <hr> 
                        <div class="sear">
                          <div style="float: left;"><button style="background: blue; border: none; padding: 12px 12px; "><a style="text-decoration: none; color: #fff;" href="admin_them.php">Thêm Tài Khoản</a></button></div>
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php 
                            ...
                            $sql="select count(admin_name) as number from admin";
                            ...
                            include 'connect.php';
                            $sql= 'select * from admin limit '.$index.',5';
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $rows['permission_id']; ?></td>
                          <td><?php echo $rows['dateday']; ?></td>
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="xulyTrangthai.php?id_admin=<?php echo $rows['id_admin']; ?>&tt=<?php echo $rows['status']; ?>"><?php 
                                    if ($rows['status']==0) {
                                      echo "False";
                                    }
                                    else
                          ...
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><?php echo "<a href='admin_sua.php?id_admin=".$rows['id_admin']."'>Sửa</a>" ;?></button></td>
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="admin_xoa.php?id_admin=<?php echo $rows['id_admin'];?>" onclick="return confirm('Ban co chac chan khong?');">xoá</a></button></td>
                        </tr>
                      </tbody>
                      <?php $counter++; ?>
                        <?php } 
