              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <div style="float: right;">
                    <button><a href="adminn.php">Quay Lại</a></button>
                  </div>
                  <h4 class="card-title">QUẢN LÝ MÓN ĂN - MÓN ĂN</h4>
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="MaMonAn" value="<?php echo $rows['id_admin']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="admin_name" value="<?php echo $rows['admin_name']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="permission_id" value="<?php echo $rows['permission_id']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Ngày Cập Nhật</label>
                      <input type="text" class="form-control" name="dateday" value="<?php echo $rows['dateday']; ?>">
                    </div>
...
if(isset($_POST["permission_id"]))  $permission_id = $_POST['permission_id'];
if(isset($_POST["dateday"]))  $dateday = $_POST['dateday'];
...
$sl="update admin set name='$name',admin_name='$admin_name',password='$password',permission_id='$permission_id',dateday='$dateday',status='$status' where id_admin ='$key'";    
