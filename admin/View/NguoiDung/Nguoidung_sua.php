              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <div style="float: right;">
                    <button style="background: #125252; border: none; padding: 8px 12px; "><a style="text-decoration: none; color: #fff;" href="nguoidungg.php">Quay Lại</a></button>
                  </div>
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="MaMonAn" value="<?php echo $rows['ID']; ?>">
                    <div class="form-group">
                      <label for="usr">Tên Người Dùng</label>
                      <input type="text" class="form-control" name="TenNguoiDung" value="<?php echo $rows['TenNguoiDung']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Tên Truy Cập</label>
                      <input type="text" class="form-control" name="TenTruyCap" value="<?php echo $rows['TenTruyCap']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Mật Khẩu</label>
                      <input type="text" class="form-control" name="MatKhau" value="<?php echo $rows['MatKhau']; ?>">
                    </div>
...
//     }
 ...
 //lay gia tri cho tham so
    $tam="";
if(isset($_POST["TenNguoiDung"]))  $TenNguoiDung = $_POST['TenNguoiDung'];
if(isset($_POST["TenTruyCap"]))  $TenTruyCap = $_POST['TenTruyCap'];
...
$sl="update taikhoan set TenNguoiDung='$TenNguoiDung',TenTruyCap='$TenTruyCap',MatKhau='$MatKhau',NgayCapNhat='$NgayCapNhat',TrangThai='$TrangThai' where ID='$key'";    
