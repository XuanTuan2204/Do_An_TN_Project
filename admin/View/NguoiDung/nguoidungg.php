              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH QUẢN LÝ NGƯỜI DÙNG</h1>
                        <hr>
                        <div class="sear">
                          <div style="float: left;"><button style="background: blue; border: none; padding: 12px 12px; "><a style="text-decoration: none; color: #fff;" href="nguoidung_them.php">Thêm Tài Khoản</a></button></div>
                          <div class="sear1" style="float: right;margin-left: 50px;"><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
                          </div>
                          <div style="float: right; padding: 10px; "><h4>Tìm Kiếm Món Ăn</h4> </div>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php 
                            ...
                            $sql="select count(TenTruyCap) as number from taikhoan";
                            $result = exexuteResult($sql);
                            $number = 0;
                            ...
                            include 'connect.php';
                            $sql= 'select * from taikhoan limit '.$index.',5';
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $rows['TenNguoiDung']; ?></td>
                          <td><?php echo $rows['TenTruyCap']; ?></td>
                          <td><?php echo $rows['MatKhau']; ?></td>
                          <td><?php echo $rows['NgayCapNhat']; ?></td>
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="xulyTrangthai.php?ID=<?php echo $rows['ID']; ?>&tt=<?php echo $rows['TrangThai']; ?>"><?php 
                                    if ($rows['TrangThai']==0) {
                                      echo "False";
                                    }
                                    else
                          ...
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><?php echo "<a href='Nguoidung_sua.php?ID=".$rows['ID']."'>Sửa</a>" ;?></button></td>
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="Nguoidung_xoa.php?ID=<?php echo $rows['ID'];?>" onclick="return confirm('Ban co chac chan khong?');">xoá</a></button></td>
                        </tr>
                      </tbody>
                      <?php $counter++; ?>
                        <?php } 
