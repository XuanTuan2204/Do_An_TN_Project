              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <h4 class="card-title">THÊM NGƯỜI DÙNG</h4>
                   <form action="Nguoidung_xlthem.php" method="post" enctype="multipart/form-data">
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">Tên Người Dùng</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Small" name="TenNguoiDung" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      
                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">Tên Truy Cập</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Small" name="TenTruyCap" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      ...
                      <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" aria-label="Small" name="MatKhau" aria-describedby="inputGroup-sizing-sm">
                      </div>

                      <div class="input-group input-group-sm mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-sm">Nhập Lại Mật Khẩu</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Small" name="#" aria-describedby="inputGroup-sizing-sm">
                      </div>
                      <input type="submit" name="Them" value="Tạo Tài Khoản">
                    </form> 
