          ...
          <div class="row">
              <div class="card card-rounded">
                <div class="card-body">
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php                      
                            include 'connect.php';
                            $sql= 'SELECT DISTINCT TenTruyCap, updateday, TrangThai FROM order_product WHERE date(updateday)=curdate() AND TrangThai=0';
                      ...
                      <tbody>
                        <tr>
                          ...
                          <?php echo "<td><a href='dsorder.php?TenTruyCap=".$rows['TenTruyCap']."&n=".$rows['updateday']."'>Xem</a></td>" ;?>
                  ...
                  <div>
                    <button><a href="../../adminbep.php">Quay Lại</a></button>
                  </div>
                  </div>
                </div>
              </div>
