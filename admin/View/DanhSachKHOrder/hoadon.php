          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="View/TKadmin/index.php">Admin</a></li>
              </ul>
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="View/NguoiDung/index.php">Người Dùng</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="View/MonAn/index.php">Món Ăn</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="View/DanhsachKHOrder/index.php">Danh sách Khách hàng</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH KHÁCH HÀNG ORDER MÓN ĂN</h1>
                        <hr>
                        <div class="sear">
                  ...
                  <div>
                    ...
                    <div class="table-responsive">
                      <table class="table" id="myTable">
                        <thead>
                          <tr>
                           ...
                           <?php                      
                              include 'connect.php';
                              $sql= 'SELECT DISTINCT TenTruyCap,SoBan, TrangThai FROM order_product WHERE date(updateday)=curdate() AND TrangThai>0';
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><?php 
                            include 'connect.php';
                              if (isset($rows['TenTruyCap'])) {
                                  $TenTruyCap = $rows['TenTruyCap'];
                      ...
                      ?></td>
                            ...
                            <td style="text-align: center;"><button style="background: #125252; border: none; padding: 10px 12px; "><?php echo "<a href='hoadondetail.php?TenTruyCap=".$rows['TenTruyCap']."&n=".$rows['SoBan']."'>Xem Hoá Đơn</a>" ;?></button></td>
                          </tr>
                        </tbody>
                        <?php $counter++; ?>
                          <?php } 
