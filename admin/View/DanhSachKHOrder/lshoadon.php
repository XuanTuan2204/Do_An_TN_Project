                      ...
                      <table class="table" id="myTable">
                        <thead>
                          <tr>
                           ...
                           <?php                      
                              include 'connect.php';
                              $sql= 'SELECT DISTINCT TenTruyCap FROM order_product';
                        ...
                        <tbody>
                          <tr>
                            ...
                            include 'connect.php';
                              ...
                              echo "" . $qty . "";
                      ?></td>
                            <td style="text-align: center;"><button style="background: #125252; border: none; padding: 10px 12px; "><?php echo "<a href='detailhd.php?TenTruyCap=".$rows['TenTruyCap']."'>Xem Hoá Đơn</a>" ;?></button></td>
                          </tr>
                        </tbody>
                        <?php $counter++; ?>
                          <?php } 
