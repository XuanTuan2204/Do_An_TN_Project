              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">LỊCH SỬ HOÁ ĐƠN KHÁCH HÀNG</h1>
                        <hr>
                        ...
                        <thead>
                          <tr>
                           ...
                           <?php
                              $key = $_GET['TenTruyCap'];
                              include 'connect.php';
                              $sql="SELECT order_product.SoBan, monan.TenMonAn,order_product.SoLuong,monan.Gia,monan.NoiDung,order_product.updateday,order_product.TenTruyCap,(monan.Gia * order_product.SoLuong) as total FROM monan, order_product WHERE monan.MaMonAn=order_product.MaMonAn AND TenTruyCap='$key'";
                ...
                <div>
                  <button style="background: #125252; border: none; padding: 10px 12px; "><a href="lshoadon.php">Quay Lại</a></button>
                 </div>
                  </div>
                </div>
              </div>
