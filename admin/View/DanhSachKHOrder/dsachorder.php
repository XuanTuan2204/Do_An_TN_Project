              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH MÓN ĂN CỦA KHÁCH HÀNG</h1>
                        <hr>
                        <div class="sear">
                          <div style="float: left; "><h4><b>Khách Hàng: <?php 
                            include 'connect.php';
                              ...
                              echo "" . $qty . "";
                      ?></h4><h4>Số Bàn: <?php echo $_GET['SoBan']; ?></b></h4> </div>
                      ...
                      <thead>
                        <tr>
                         ...
                         <?php
                            ...
                            $n = $_GET['n'];
                            include 'connect.php';
                            $sql="SELECT monan.TenMonAn, monan.Anh, monan.NoiDung,order_product.updateday,order_product.TenTruyCap, order_product.TrangThai,monan.Gia,order_product.SoLuong,(monan.Gia * order_product.SoLuong) as total FROM monan, order_product WHERE TenTruyCap='$key' AND monan.MaMonAn=order_product.MaMonAn AND order_product.SoLuong > 0 and updateday='$n'";
                  ...
                  <div style="margin-top: 20px;">
                        <p style="float: right; margin-right: 50px; margin-top: 10px;"><b>Tổng Tiền :  <?php 
                          include 'connect.php';
                            $query= "SELECT SUM(monan.Gia * order_product.SoLuong) AS Tong FROM monan, order_product WHERE TenTruyCap='$key' AND monan.MaMonAn=order_product.MaMonAn AND updateday='$n' AND order_product.TrangThai =1"; 
                            $query_run = mysqli_query($connect,$query);
                        while ($num = mysqli_fetch_assoc ($query_run)) {
                            $qty = $num['Tong'];
                        }
                        $formattedNum = number_format($qty, 0, ',', '.');
                        echo ""  .$formattedNum. "" ; ?></b></p>
                        <button style="background: blue; border: none; padding: 12px 12px; float: left; "><a style="text-decoration: none; color: #fff;" href="khorder.php">Quay Lại</a></button>
                  </div>
                </div>
              </div>
            </div>
