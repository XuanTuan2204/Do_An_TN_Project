                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php                      
                            include 'connect.php';
                            $sql= 'SELECT DISTINCT TenTruyCap, updateday,SoBan, TrangThai FROM order_product WHERE date(updateday)=curdate() AND TrangThai>=0';
                      ...
                      ?></td>
                          ...
                          <td><button style="background: #0D4F4F; border: none; padding: 10px 25px;"><?php echo "<a href='dsachorder.php?TenTruyCap=".$rows['TenTruyCap']."&n=".$rows['updateday']."&SoBan=".$rows['SoBan']."'>Xem</a>" ;?></button></td>
