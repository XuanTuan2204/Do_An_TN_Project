              ...
              <div class="card card-rounded">
                <div class="card-body">
                  ...
                  <div style="float: left;">
                    <button style="background: #125252; border: none; padding: 8px 12px; "><a style="text-decoration: none; color: #fff;" href="monan.php">Quay Lại</a></button>
                  </div>
                  <h4 class="card-title" style="text-align: center;">QUẢN LÝ MÓN ĂN - MÓN ĂN</h4>
                   <hr>
                   <?php
                         include('connect.php'); 
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="MaMonAn" value="<?php echo $rows['MaMonAn']; ?>">
                    <div class="form-group">
                      <label for="usr">Tên Món Ăn</label>
                      <input type="text" class="form-control" name="TenMonAn" value="<?php echo $rows['TenMonAn']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Loại Món Ăn</label>
                      <input type="text" class="form-control" name="MaLoaiMonAn" value="<?php echo $rows['MaLoaiMonAn']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Tiêu Đề</label>
                      <input type="text" class="form-control" name="TieuDe" value="<?php echo $rows['TieuDe']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Ảnh</label>
                      <img src="../upload/<?php echo $rows['Anh'] ?>" width="40" height="40" />
                      <td>  <input type="file" name="image" id="image"  /> </td>
                    </div>
                    <div class="form-group">
                      <label for="usr">Nội Dung</label>
                      <input type="text" class="form-control" name="NoiDung" value="<?php echo $rows['NoiDung']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Ngày Cập Nhật</label>
                      <input type="text" class="form-control" name="NgayCapNhat" value="<?php echo $rows['NgayCapNhat']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Giá</label>
                      <input type="text" class="form-control" name="Gia" value="<?php echo $rows['Gia']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="usr">Trạng Thái</label>
                      <input type="text" class="form-control" name="TrangThai" value="<?php echo $rows['TrangThai']; ?>">
                    </div>
                    <div class="form-group">
...
<?php
// upload hinh anh
  if(isset($_FILES["image"]["name"]))   $Anh=$_FILES["image"]["name"];
  if(isset($_FILES['image']['tmp_name'])) { 
  $anhminhhoa_tmp=$_FILES['image']['tmp_name'];
            if(isset($_GET['MaMonAn'])){
            $id=$_GET['MaMonAn'];
            $sl="select Anh from monan where MaMonAn='$id'";}
 ...
 //lay gia tri cho tham so
    $tam="";
if(isset($_POST["TenMonAn"]))  $TenMonAn = $_POST['TenMonAn'];
if(isset($_POST["MaLoaiMonAn"]))  $MaLoaiMonAn = $_POST['MaLoaiMonAn'];
if(isset($_POST["TieuDe"])) $TieuDe= $_POST['TieuDe'];
if(isset($_POST["NoiDung"]))  $NoiDung = $_POST['NoiDung'];
if(isset($_POST["NgayCapNhat"]))  $NgayCapNhat = $_POST['NgayCapNhat'];
...
if (isset($_POST['update'])) 
  ...
  if($Anh=="")
  {   
$sl="update monan set TenMonAn='$TenMonAn',MaLoaiMonAn='$MaLoaiMonAn',TieuDe='$TieuDe',NoiDung='$NoiDung',NgayCapNhat='$NgayCapNhat',Gia='$Gia',TrangThai='$TrangThai' where MaMonAn='$key'";    
  }
  else
  {
$sl="update monan set TenMonAn='$TenMonAn',MaLoaiMonAn='$MaLoaiMonAn',Anh='$Anh', TieuDe='$TieuDe',NoiDung='$NoiDung',NgayCapNhat='$NgayCapNhat',Gia='$Gia',TrangThai='$TrangThai' where MaMonAn='$key'";
  }
//$uup=mysql_query($sl);
...
{
  echo "<script language='javascript'>alert('Sửa Sản Phẩm Thành Công');";
