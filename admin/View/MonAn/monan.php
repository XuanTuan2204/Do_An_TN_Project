      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block">
            <a class="nav-link dropdown-bordered dropdown-toggle dropdown-toggle-split" id="messageDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false"> Select Product </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
              <a class="dropdown-item py-3" >
                <p class="mb-0 font-weight-medium float-left">Select Product</p>
              </a>
              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH QUẢN LÝ MÓN ĂN</h1>
                        <hr>
                        <div class="sear">
                          <div style="float: left;"><button style="background: blue; border: none; padding: 12px 12px; "><a style="text-decoration: none; color: #fff;" href="product_them.php">Thêm Món Ăn</a></button></div>
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php 
                            ...
                            $sql="select count(MaMonAn) as number from monan";
                            ...
                            include 'connect.php';
                            $sql= 'select * from monan limit '.$index.',8';
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $rows['MaMonAn']; ?></td>
                          <td><?php echo $rows['MaLoaiMonAn']; ?></td>
                          ...
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="xulyTrangthai.php?MaMonAn=<?php echo $rows['MaMonAn']; ?>&tt=<?php echo $rows['TrangThai']; ?>"><?php 
                                    if ($rows['TrangThai']==0) {
                                      echo "False";
                                    }
                                    else
                          ...
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><?php echo "<a href='product_sua.php?MaMonAn=".$rows['MaMonAn']."'>Sửa</a>" ;?></button></td>
                          <td><button style="background: #125252; border: none; padding: 10px 12px; "><a href="product_xoa.php?MaMonAn=<?php echo $rows['MaMonAn'];?>" onclick="return confirm('bạn có chắc chán muốn xoá <?php echo $rows['TenMonAn']; ?> ?');">Xoá</a></button></td>
                        </tr>
                      </tbody>
                      <?php $counter++; ?>
                        <?php } 
                  ...
                  <div style="margin-top: 20px;">
                      <ul class="pagination filter-active">
                        <?php 
                          for ($i=1; $i <= $pages ; $i++) { 
