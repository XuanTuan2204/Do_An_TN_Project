  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="adminbep.php">
              ...
              <div class="card card-rounded">
                <div class="card-body">
                  <div class="d-sm-flex justify-content-between align-items-start">
                      <div class="card-body">
                        <h1 class="card-title" style="text-align: center;">DANH SÁCH KHÁCH HÀNG ORDER MÓN ĂN(Chờ xử lý)</h1>
                        <hr>
                        <div class="sear">
                    ...
                    <table class="table" id="myTable">
                      <thead>
                        <tr>
                         ...
                         <?php                      
                            include '../database/connect.php';
                            $sql= 'SELECT DISTINCT TenTruyCap,SoBan, updateday, TrangThai FROM order_product WHERE date(updateday)=curdate() AND TrangThai=0';
                      ...
                      ?></td>
                          ...
                          <td><?php 
                                    ...
                                    elseif ($rows['TrangThai']==1) {
                                      echo "Đã Xử Lý";
                                    }
                                      
                                ?>   
                          </td>  
                        <td><button style="background: #0D4F4F; border: none; padding: 10px 25px;"><?php echo "<a href='View/DanhSachKHOrder/dsorder.php?TenTruyCap=".$rows['TenTruyCap']."&n=".$rows['updateday']."&SoBan=".$rows['SoBan']."'>Xem</a>" ;?></button></td>
                         <style type="text/css">
                           button a{
