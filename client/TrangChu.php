          ...
          <li>
            <form action="TrangChu.php" method="post">
              <div class="aitssendbuttonw3ls">
                <a class="w3_play_icon1" href="#small-dialog1">Đăng Nhập</a><a href="">/</a><a class="w3_play_icon1" href="#small-dialog2">Đăng ký</a>
                <div class="clear"></div>
              </div>
            </form>
          </li>
...
<?php
                        ...
                        if (isset($_POST["Login-submit"])) {
                           ...
                           if ($TenTruyCap == "" || $MatKhau =="") {
                              ...
                              $sql = "select * from taikhoan where TenTruyCap = '$TenTruyCap' and MatKhau = '$MatKhau' ";
                              $query = mysqli_query($connect,$sql);
                              $num_rows = mysqli_fetch_array($query);
                              if ($num_rows==0) {
                                echo "Tên đăng nhập hoặc mật khẩu không đúng!";
                              }else {
                                    if($num_rows['TrangThai'] == '0')
                                    {
                                       $_SESSION['TenTruyCap'] = $TenTruyCap;
                                       echo "Tài Khoản Đã Bị Khoá";
                                    }  
                                    else if($num_rows['TrangThai'] == '1')
                                    {
                                       $_SESSION['TenTruyCap'] = $TenTruyCap;
...
<!-- for login popup -->
  ...
  <div id="small-dialog1" class="mfp-hide">
    ...
    <h2>Mời Bạn Đăng Nhập</h2>
      <form action="TrangChu.php" method="post">
        <input type="text" Name="TenTruyCap" placeholder="Tên đăng nhập" required="">
        ...
        <div class="aitssendbuttonw3ls">
          <input style="width: 50%;" type="submit" name="Login-submit" value="Login">
        </div>
      </form>
    </div>
  </div>
  ...
  <div id="small-dialog2" class="mfp-hide">
    <div class="contact-form1">
      <div class="contact-w3-agileits">
        ...
        <form action="dktaikhoan.php" method="post">
            ...
            <div class="form-sub-w3ls">
              <input placeholder="Nhập lại Mật Khẩu" name="#" type="password" required="">
              <div class="icon-agile">
                <i class="fa fa-unlock-alt" aria-hidden="true"></i>
              </div>
            </div>
            ...
            <div class="submit-w3l">
              <input style="width: 50% ;" type="submit" name="Register-submit" value="Register">
            </div>
        </form>
      </div>
    </div>  
