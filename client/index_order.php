      ...
      <div class="container" data-aos="fade-up">
         ...
         <style type="text/css">
              ...
              <table class="table">
                      <thead>
                        <tr>
                         ...
                         <?php
                            include 'connect.php';
                            $sql="SELECT monan.TenMonAn, monan.Anh, monan.NoiDung,order_product.TenTruyCap, order_product.TrangThai,monan.Gia,order_product.SoLuong,(monan.Gia * order_product.SoLuong) as total FROM monan, order_product WHERE TenTruyCap='$TenTruyCap' AND monan.MaMonAn=order_product.MaMonAn AND order_product.SoLuong > 0 and date(updateday) = curdate()";
          ...
          <div style="margin-top: 20px;">
                <p style="float: left; margin-left: 110px;">Tổng Tiền :  <?php 
                  include 'connect.php';
                    $query= "SELECT SUM(monan.Gia * order_product.SoLuong) AS Tong FROM monan, order_product WHERE TenTruyCap='$TenTruyCap' AND monan.MaMonAn=order_product.MaMonAn AND date(updateday)=curdate()"; 
                    $query_run = mysqli_query($connect,$query);
                while ($num = mysqli_fetch_assoc ($query_run)) {
                    $qty = $num['Tong'];
                }
